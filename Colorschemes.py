""" Module to set the colors for the QT window, not for the plots"""
...
def reset_colors(mdict):
    """
    function to replace the default colors defined above

    :param mdict:  dictionary with entries for WHITE, BLACK, PRIMARY, SECONDARY and TERTIARY
    """
